...
int main() {
    ...
    cv::Mat base_img = cv::imread("./images/Europe.png");
    ...
    drawFlightGreedyPath(base_img, city_coords, min_cost_path_greedy, "./images/E3Flight_Greedy_MinCost_Path.png");
    drawFlightGreedyPath(base_img, city_coords, min_time_path_greedy, "./images/E3Flight_Greedy_MinTime_Path.png");

    // Draw and save paths for Divide and Conquer
    drawFlightDCPath(base_img, city_coords, min_cost_path_dc, "./images/E3Flight_DC_MinCost_Path.png");
    drawFlightDCPath(base_img, city_coords, min_time_path_dc, "./images/E3Flight_DC_MinTime_Path.png");

    // Draw and save paths for DP
    drawFlightDPPath(base_img, city_coords, min_cost_path_dp, "./images/E3Flight_DP_MinCost_Path.png");
    drawFlightDPPath(base_img, city_coords, min_time_path_dp, "./images/E3Flight_DP_MinTime_Path.png");

    // Write Greedy paths to CSV
    writeCityOrderToCSV("./tables/E3Flight_Greedy_MinCost_Path.csv", min_cost_path_greedy, city_names, city_coords, total_cost_greedy_cost_path, total_time_greedy_cost_path);
    writeCityOrderToCSV("./tables/E3Flight_Greedy_MinTime_Path.csv", min_time_path_greedy, city_names, city_coords, total_cost_greedy_time_path, total_time_greedy_time_path);

    // Write Divide and Conquer paths to CSV
    writeCityOrderToCSV("./tables/E3Flight_DC_MinCost_Path.csv", min_cost_path_dc, city_names, city_coords, total_cost_dc_cost_path, total_time_dc_cost_path);
    writeCityOrderToCSV("./tables/E3Flight_DC_MinTime_Path.csv", min_time_path_dc, city_names, city_coords, total_cost_dc_time_path, total_time_dc_time_path);

    // Write DP paths to CSV
    writeCityOrderToCSV("./tables/E3Flight_DP_MinCost_Path.csv", min_cost_path_dp, city_names, city_coords, total_cost_dp_cost_path, total_time_dp_cost_path);
    writeCityOrderToCSV("./tables/E3Flight_DP_MinTime_Path.csv", min_time_path_dp, city_names, city_coords, total_cost_dp_time_path, total_time_dp_time_path);
...
#ifdef _WIN32
    system("start ./images/E3Flight_Greedy_MinCost_Path.png");
    system("start ./images/E3Flight_Greedy_MinTime_Path.png");
    system("start ./images/E3Flight_DC_MinCost_Path.png");
    system("start ./images/E3Flight_DC_MinTime_Path.png");
    system("start ./images/E3Flight_DP_MinCost_Path.png");
    system("start ./images/E3Flight_DP_MinTime_Path.png");
#elif __APPLE__
    system("open ./images/E3Flight_Greedy_MinCost_Path.png");
    system("open ./images/E3Flight_Greedy_MinTime_Path.png");
    system("open ./images/E3Flight_DC_MinCost_Path.png");
    system("open ./images/E3Flight_DC_MinTime_Path.png");
    system("open ./images/E3Flight_DP_MinCost_Path.png");
    system("open ./images/E3Flight_DP_MinTime_Path.png");
#elif __linux__
    system("xdg-open ./images/E3Flight_Greedy_MinCost_Path.png");
    system("xdg-open ./images/E3Flight_Greedy_MinTime_Path.png");
    system("xdg-open ./images/E3Flight_DC_MinCost_Path.png");
    system("xdg-open ./images/E3Flight_DC_MinTime_Path.png");
    system("xdg-open ./images/E3Flight_DP_MinCost_Path.png");
    system("xdg-open ./images/E3Flight_DP_MinTime_Path.png");
#endif
